...
export default function ArtistToolbar({
  artists,
  selectedMails,
  onOpenSidebar,
  onToggleDense,
  ...
  const selectedAllMails = selectedMails === artists && artists > 0;
  const selectedSomeMails = selectedMails > 0 && selectedMails < artists;
